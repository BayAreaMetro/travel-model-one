...
def read_tour_mode_choice_logsum_lines(file_object, type_str, attr_dict, base_or_build, log_file):
    ...
    """
    print(f"read_tour_mode_choice_logsum_lines with {type_str=} {attr_dict=} {base_or_build=}")
    #if destTaz > 25:
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if match:
            print(f"tour_mc_re match: {match.groupdict()}")
            ...
            print(f"Found Tour Mode Choice info for type_str={type_str} attributes: {attrs_dict}")
