...
PSEUDO_LINE_MAPPING = {
    # baseline
    "120_OR_YEL"  :("120_ORANGE[-A]$","120_YELLOW[-89W]$"), # Orange/Richmond - MacArthur - Yellow/SFO
    "120_OR_YER"  :("120_YELLOW[13E]?$","120_ORANGE(A-)?$"), # Yellow/SFO - MacArthur - Orange/Richmond
    # crossings 3
