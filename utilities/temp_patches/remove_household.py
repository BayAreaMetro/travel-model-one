...
if __name__ == "__main__":
    ...
    print(
        "Removing the following: \n{}\n".format(
            households_df.loc[households_df.HHID == args.household_id]
        )
    )
    log_file.write(
        "Removing the following: \n{}\n".format(
    ...
    print(
        "Removed household with id {}; new len is {}".format(
            args.household_id, len(households_df)
        )
    )
    log_file.write(
        "Removed household with id {}; new len is {}\n".format(
            args.household_id, len(households_df)
        )
    )
    ...
    print(
        "Removing the following: \n{}\n".format(
            persons_df.loc[persons_df.HHID == args.household_id]
        )
    )
    log_file.write(
        "Removing the following: \n{}\n".format(
    ...
    print(
        "Removed household with id {}; new len is {}".format(
            args.household_id, len(persons_df)
        )
    )
    log_file.write(
        "Removed household with id {}; new len is {}\n".format(
