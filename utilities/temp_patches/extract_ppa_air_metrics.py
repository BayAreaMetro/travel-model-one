...
if __name__ == '__main__':
    ...
    for directory in dirs:
        ...
        if m != None:
            ...
            base_metrics_df = read_air_metrics(model_id=directory, base_id=directory, 
            ...
            subdirs = sorted(os.listdir(os.path.join(MODEL_DIRS_PATH_DEFAULT, directory)))
            ...
            for subdirectory in subdirs:
                ...
                if m2 != None:
                    ...
                    print("Project run found: {}  base_dir: {}".format(subdirectory, m2.group(1)))

                    project_metrics_df = read_air_metrics(model_id=subdirectory, base_id=m2.group(1),
                                                          directory=os.path.join(MODEL_DIRS_PATH_DEFAULT, directory, subdirectory),
                                                          air_metrics_df=project_metrics_df)
    # print(project_metrics_df)
    # print(base_metrics_df)

    # join project metrics with base
    metrics_df = pandas.merge(left=project_metrics_df,
