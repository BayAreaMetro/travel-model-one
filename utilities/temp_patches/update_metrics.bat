...
copy /Y \\tsclient\X\travel-model-one-master\utilities\PBA40\metrics\* CTRAMP\scripts\metrics
copy /Y \\tsclient\X\travel-model-one-master\utilities\PBA40\RunMetrics.bat .
