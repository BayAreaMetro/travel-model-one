...
for tp in timeperiodList:
    ...
    # speed bins
    Speed_conditions = [
        (loadednet_df['cspd'+tp] >= 0) & (loadednet_df['cspd'+tp] < 5 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 5 + CARB_ADD) & (loadednet_df['cspd'+tp] < 10 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 10 + CARB_ADD) & (loadednet_df['cspd'+tp] < 15 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 15 + CARB_ADD) & (loadednet_df['cspd'+tp] < 20 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 20 + CARB_ADD) & (loadednet_df['cspd'+tp] < 25 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 25 + CARB_ADD) & (loadednet_df['cspd'+tp] < 30 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 30 + CARB_ADD) & (loadednet_df['cspd'+tp] < 35 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 35 + CARB_ADD) & (loadednet_df['cspd'+tp] < 40 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 40 + CARB_ADD) & (loadednet_df['cspd'+tp] < 45 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 45 + CARB_ADD) & (loadednet_df['cspd'+tp] < 50 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 50 + CARB_ADD) & (loadednet_df['cspd'+tp] < 55 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 55 + CARB_ADD) & (loadednet_df['cspd'+tp] < 60 + CARB_ADD),
        (loadednet_df['cspd'+tp] >= 60 + CARB_ADD)]
