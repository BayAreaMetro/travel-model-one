...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--vehclasses", action="store_true", help="Pass to run on vehclasses file"
    )
    parser.add_argument("model_run", help="Model run")
    args = parser.parse_args()

    inputfile = "avgload5period{}_{}.csv".format(
        "_vehclasses" if args.vehclasses else "", args.model_run
    )
    outputfile = "avgload5periodlong{}_{}.csv".format(
        "_vehclasses" if args.vehclasses else "", args.model_run
    )
