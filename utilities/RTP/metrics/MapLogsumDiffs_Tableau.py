...
logsums_work_df = pd.read_table(os.path.join(sys.argv[1], 'OUTPUT', 'logsums', "person_workDCLogsum.csv"), sep=",")
logsums_shop_df = pd.read_table(os.path.join(sys.argv[1], 'OUTPUT', 'logsums', "tour_shopDCLogsum.csv"), sep=",")

# reading logsums by market segment for corresponding base
print(os.path.join('OUTPUT', 'logsums', "person_workDCLogsum.csv"))
logsums_work_df_base = pd.read_table(os.path.join(os.getcwd(), 'OUTPUT', 'logsums', "person_workDCLogsum.csv"), sep=",")
logsums_shop_df_base = pd.read_table(os.path.join(os.getcwd(), 'OUTPUT', 'logsums', "tour_shopDCLogsum.csv"), sep=",")
...
markets_df = pd.read_table(os.path.join(sys.argv[1], 'OUTPUT', 'core_summaries', "AccessibilityMarkets.csv"), sep=",")
markets_df_base = pd.read_table(os.path.join(os.getcwd(), 'OUTPUT', 'core_summaries', "AccessibilityMarkets.csv"), sep=",")
...
dir_segments = os.path.join(os.getcwd(), 'logsum_diff_map', 'Market Segments')
if not os.path.exists(dir_segments):
    os.makedirs(dir_segments)
dir_population = os.path.join(os.getcwd(),'logsum_diff_map', 'Population')
if not os.path.exists(dir_population):
    os.makedirs(dir_population)


# writing logsum diff files by market segment for tableau
logsums_work_filename = os.path.join(os.getcwd(), 'logsum_diff_map', 'Market Segments',  "person_workDCLogsum_compare.csv")
...
logsums_shop_filename = os.path.join(os.getcwd(), 'logsum_diff_map', 'Market Segments',  "tour_shopDCLogsum_compare.csv")
...
logsums_pop_work_filename = os.path.join(os.getcwd(), 'logsum_diff_map', 'Population',  "person_workDCLogsum_cs_compare.csv")
...
logsums_pop_shop_filename = os.path.join(os.getcwd(), 'logsum_diff_map', 'Population',  "tour_shopDCLogsum_cs_compare.csv")
