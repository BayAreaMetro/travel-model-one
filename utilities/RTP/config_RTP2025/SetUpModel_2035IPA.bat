...
set M_DIR=M:\Application\Model One\RTP2025\IncrementalProgress\2035_TM160_IPA_10
...
set PREV_RUN_DIR=M:\Application\Model One\RTP2025\IncrementalProgress\2035_TM160_IPA_09
