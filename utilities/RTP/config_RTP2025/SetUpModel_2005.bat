...
set M_DIR=M:\Application\Model One\RTP2025\IncrementalProgress\2005_TM160_IPA_04
...
set INPUT_NETWORK=M:\Application\Model One\RTP2021\IncrementalProgress\2005_TM152_IPA_03\INPUT

:: set the location of the populationsim and land use inputs (make sure the land use version and year are correct) 
set INPUT_POPLU=M:\Application\Model One\RTP2025\INPUT_DEVELOPMENT\LandUse_n_Popsyn\2005_v01
...
set PREV_RUN_DIR=M:\Application\Model One\RTP2025\IncrementalProgress\2005_TM160_IPA_03
...
set PARAMS=X:\travel-model-one-master\utilities\RTP\config_RTP2025\params_2005.properties
