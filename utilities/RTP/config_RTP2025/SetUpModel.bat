...
set INPUT_POPLU=M:\Application\Model One\RTP2025\INPUT_DEVELOPMENT\LandUse_n_Popsyn\2023_v03
...
set INPUT_DEVELOPMENT_DIR=M:\Application\Model One\RTP2025\INPUT_DEVELOPMENT
...
set PREV_RUN_DIR=M:\Application\Model One\RTP2025\IncrementalProgress\2023_TM152_IPA_16
...
:: logsums and metrics
c:\windows\system32\Robocopy.exe /NP /E "%INPUT_DEVELOPMENT_DIR%\logsums_dummies"                    INPUT\logsums
:: c:\windows\system32\Robocopy.exe /NP /E "%INPUT_DEVELOPMENT_DIR%\metrics\metrics_FinalBlueprint"     INPUT\metrics
