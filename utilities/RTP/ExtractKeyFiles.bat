...
copy nonres\tripsIX*.tpp          OUTPUT\nonres
copy nonres\tripsTrk*.tpp         OUTPUT\nonres
...
mkdir OUTPUT\logsums\ForUrbanSim
copy logsums\mandatoryAccessibilities.csv            OUTPUT\logsums\ForUrbanSim\mandatoryAccessibilities_%model_year%_%UrbanSimScenario%.csv 
copy logsums\nonMandatoryAccessibilities.csv         OUTPUT\logsums\ForUrbanSim\nonMandatoryAccessibilities_%model_year%_%UrbanSimScenario%.csv   
copy core_summaries\AccessibilityMarkets.csv         OUTPUT\logsums\ForUrbanSim\AccessibilityMarkets_%model_year%_%UrbanSimScenario%.csv   
...
mkdir OUTPUT\shapefile
copy X:\travel-model-one-master\utilities\cube-to-shapefile\run_CubeToShapefile.bat OUTPUT\shapefile
