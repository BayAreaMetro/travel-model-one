...
percentage_pay800plus_outOfAllHhld <- (num_pay800plus / total_records ) * 100
...
percentage_pay800plus_incQ1_outOfPay800plus <- (num_pay800plus_incQ1 / num_pay800plus ) * 100
num_incQ1                                   <- sum(df_hhldCosts$hhld_incQ == 1)
percentage_pay800plus_incQ1_outOfIncQ1      <- (num_pay800plus_incQ1 / num_incQ1 ) * 100

# among those who pay 90th percentile, how many of those are low-income
num_payP90plus                              <- sum(df_hhldCosts$annual_valueNcordon_toll >= quantile(df_hhldCosts$annual_valueNcordon_toll, 0.9)) # could be a tiny bit different from total_records*0.1
num_payP90plus_incQ1                        <- sum(df_hhldCosts$annual_valueNcordon_toll >= quantile(df_hhldCosts$annual_valueNcordon_toll, 0.9) & df_hhldCosts$hhld_incQ == 1)
percentage_payP90plus_incQ1_outOfPayP90plus <- (num_payP90plus_incQ1 / num_payP90plus ) * 100
>>>>>>> Stashed changes
...
=======
num_pay800plus
percentage_pay800plus_outOfAllHhld
num_pay800plus_incQ1
percentage_pay800plus_incQ1_outOfPay800plus
num_incQ1
percentage_pay800plus_incQ1_outOfIncQ1 
num_payP90plus
num_payP90plus_incQ1
percentage_payP90plus_incQ1_outOfPayP90plus
>>>>>>> Stashed changes
