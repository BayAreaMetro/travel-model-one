...
set M_DIR=L:\Application\Model_One\NextGenFwys\Scenarios\2035_TM152_NGF_NP10_Path3b_02
...
set INPUT_NETWORK=L:\Application\Model_One\NextGenFwys\INPUT_DEVELOPMENT\Networks\NGF_Networks_P3b_3Cordons_Affordable_04\NGF_P3b_3Cordons_Affordable_network_2035
