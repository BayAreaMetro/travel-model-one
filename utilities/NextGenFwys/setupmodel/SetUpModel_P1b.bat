...
set M_DIR=L:\Application\Model_One\NextGenFwys\Scenarios\2035_TM152_NGF_NP10_Path1b_02
...
set INPUT_NETWORK=L:\Application\Model_One\NextGenFwys\INPUT_DEVELOPMENT\Networks\NGF_Networks_P1b_AllLaneTolling_Affordable_04\NGF_P1b_AllLaneTolling_Affordable_network_2035
