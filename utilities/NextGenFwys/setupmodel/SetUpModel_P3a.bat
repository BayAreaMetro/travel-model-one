...
set M_DIR=L:\Application\Model_One\NextGenFwys\Scenarios\2035_TM152_NGF_NP10_Path3a_02
...
set INPUT_NETWORK=L:\Application\Model_One\NextGenFwys\INPUT_DEVELOPMENT\Networks\NGF_Networks_P3a_3Cordons_ImproveTransit_04\NGF_P3a_3Cordons_ImproveTransit_network_2035
