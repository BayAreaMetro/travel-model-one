...
df_FwyBiDirection.rename(columns={'aadt_NE1':'aadt', 'route_numb_NE1': 'route_numb'}, inplace=True)

#keep only the relevant columns
df_FwyBiDirection = df_FwyBiDirection[['OBJECTID_NE1', 'route_numb', 'route_numb_SW1', 'aadt', 'A_NE1', 'B_NE1', 'A_SW1', 'B_SW1',  'A_NE2', 'B_NE2','A_SW2', 'B_SW2', 'A_NE3', 'B_NE3', 'A_SW3', 'B_SW3', 'A_NE4', 'B_NE4', 'A_SW4', 'B_SW4' ]]
...
df_FwyBiDirection_GroupedbyAB['HPMS_Weekday_Vol']= df_FwyBiDirection_GroupedbyAB['aadt']*1.1
df_FwyBiDirection_GroupedbyAB['Count_minus_Modelled']=df_FwyBiDirection_GroupedbyAB['modelled_daily_volume']-df_FwyBiDirection_GroupedbyAB['HPMS_Weekday_Vol']
df_FwyBiDirection_GroupedbyAB['Count_minus_Modelled_Squared'] = df_FwyBiDirection_GroupedbyAB['Count_minus_Modelled'] * df_FwyBiDirection_GroupedbyAB['Count_minus_Modelled']

# calculate %RMSE by route
df_FwyBiDirection_GroupedbyRoute = df_FwyBiDirection_GroupedbyAB.groupby('route_numb').agg({'route_numb':['first','count'],'Count_minus_Modelled_Squared': ['sum'], 'HPMS_Weekday_Vol':['sum']})
df_FwyBiDirection_GroupedbyRoute.columns = ['route_numb', 'N_counters_matched', 'Sum_Count_minus_Modelled_Squared','Sum_HPMS_Weekday_Vol']
df_FwyBiDirection_GroupedbyRoute['RMSE']= np.sqrt(df_FwyBiDirection_GroupedbyRoute['Sum_Count_minus_Modelled_Squared']/df_FwyBiDirection_GroupedbyRoute['N_counters_matched'])
df_FwyBiDirection_GroupedbyRoute['Percent_RMSE'] = df_FwyBiDirection_GroupedbyRoute['RMSE'] / (df_FwyBiDirection_GroupedbyRoute['Sum_HPMS_Weekday_Vol']/df_FwyBiDirection_GroupedbyRoute['N_counters_matched'])
