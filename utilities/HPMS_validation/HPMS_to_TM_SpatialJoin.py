...
INPUT_HPMSshapefile = (
    r"M:\Data\Traffic\HPMS\2015\california2015\California_Sections.shp"
)
...
arcpy.conversion.FeatureClassToFeatureClass(
    ...
    "",
    "HPMS_BayArea.shp",
    "county_cod = 1 Or county_cod = 13 Or county_cod = 41 Or county_cod = 55 Or county_cod = 75 Or county_cod = 81 Or county_cod = 85 Or county_cod = 95 Or county_cod = 97",
)
...
arcpy.conversion.FeatureClassToFeatureClass(
    "HPMS_BayArea.shp",
    "",
    "HPMS_BayArea_aadt_SHS.shp",
    "aadt > 0 And route_id LIKE '%SHS%'",
)
...
for d in direction_list:
    for u in use_list:
        arcpy.conversion.FeatureClassToFeatureClass(
            INPUT_TM1shapefile,
            "",
            "freeflow_links_freeway_" + d + "_Use" + u + ".shp",
            "USE = " + u + "And ROUTEDIR = '" + d + "'",
        )
...
for d in direction_list:
    for u in use_list:
        ...
        arcpy.conversion.FeatureClassToFeatureClass(
            in_features, out_path, out_name, "route_numb = ROUTENUM"
        )
