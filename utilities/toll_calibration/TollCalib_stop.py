...
AvgSpeedIter0_df = pd.read_table(os.path.join(os.getcwd(), "el_gp_avg_speed_iter" + str(iter0) + ".csv"), sep=",")
AvgSpeedIter1_df = pd.read_table(os.path.join(os.getcwd(), "el_gp_avg_speed_iter" + str(iter1) + ".csv"), sep=",")

# Deleting unnecessary columns
AvgSpeedIter0_df = AvgSpeedIter0_df.drop(['TOLLCLASS','Case_AM','Case_MD','Case_PM','facility_name','tollam_da','tollmd_da','tollpm_da','tollam_da_new','tollmd_da_new','tollpm_da_new'], 1)
AvgSpeedIter1_df = AvgSpeedIter1_df.drop(['TOLLCLASS','Case_AM','Case_MD','Case_PM','facility_name','tollam_da','tollmd_da','tollpm_da','tollam_da_new','tollmd_da_new','tollpm_da_new'], 1)
