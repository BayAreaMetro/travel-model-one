rem This is a version of utilities/calibration/copy_output.bat to use for 
rem calibrating 2020 mode choice for transit ridership only.
rem 
rem Running in L:\Application\Model_One\TransitRecovery\transit_calibration_2020
SETLOCAL EnableDelayedExpansion

set MODEL_DIR=\\model2-d\Model2D-Share\Projects\2020_TM152_TRR_01
set TARGET_DIR=L:\Application\Model_One\TransitRecovery\transit_calibration_2020
set CODE_DIR=E:\GitHub\travel-model-one-transit-calib-2020\utilities\calibration
