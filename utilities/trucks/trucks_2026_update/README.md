...
| Observed Truck Counts Data Processing | Processes Caltrans and BATA truck count datasets for model validation and time-of-day estimation. | Observed counts by time-of-day and truck type |#TODO: Save Results in data/processed |[src/data/observed](https://github.com/BayAreaMetro/travel-model-one/tree/tm1.7_truck_updates/utilities/trucks/trucks_2026_update/src/data/observed) |
