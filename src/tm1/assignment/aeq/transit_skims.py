...
``default-configs/assignment/params.yaml`` (see :mod:`tm1.assignment.params`).
...
from tm1.assignment.params import AeqParams, SkimOutput, load_aeq_params
...
def skim_all_runs(
    ...
    *,
    ...
    params
        Loaded :class:`AeqParams`; None loads the default params.yaml.
    fare_cache
