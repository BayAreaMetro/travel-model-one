...
``default-configs/assignment/params.yaml`` (provenance documented there), NOT in the
...
DEFAULT_PARAMS_PATH = (Path(__file__).resolve().parents[3]
                       / "default-configs" / "assignment" / "params.yaml")
...
@dataclass(frozen=True)
class AeqParams:
    """Everything the aeq assignment/skim engine reads from params.yaml."""
