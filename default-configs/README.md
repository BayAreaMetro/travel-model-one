...
*deltas* against what lives here, so this must stay complete and runnable on its own.

Data files stay out: fetch or reference them instead. The exceptions are small (<1 MB),
rarely-changing, and free of personally identifiable information.
