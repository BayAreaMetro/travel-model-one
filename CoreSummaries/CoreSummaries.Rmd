...
# Pass revers_ode as TRUE to do return trip; this uses the dest taz as the origin and the origin
...
add_cost <- function(timeCode_val, tours, reverse_od=FALSE) {
  ...
  costSkims   <- mutate(costSkims,
                        ...
                        wTrnW    = ifelse(wTrnW == -999,0,wTrnW ),
                        dTrnW    = ifelse(dTrnW == -999,0,dTrnW ),
                        wTrnD    = ifelse(wTrnD == -999,0,wTrnD ))
  ...
  print(t(tours[(tours$SD==19)&(tours$tour_mode==15),]))
  print(t(tours[(tours$SD==27)&(tours$tour_mode==17),]))
  print(t(tours[(tours$SD==29)&(tours$tour_mode==12),]))
