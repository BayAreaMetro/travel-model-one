...
tazData           <- read.table(file=file.path(TARGET_DIR,"modelfiles","tazData.csv"), header=TRUE, sep=",")
...
input.pop.households <- read.table(file = file.path(TARGET_DIR,"modelfiles",paste0(POPSYN_HH,".csv")), 
                                   header=TRUE, sep=",")
input.ct.households  <- read.table(file = file.path(TARGET_DIR,"modelfiles",paste0("householdData_",ITER,".csv")), 
                                   header=TRUE, sep = ",")
...
input.pop.persons    <- read.table(file = file.path(TARGET_DIR,"modelfiles",paste0(POPSYN_PERS,".csv")), 
                                   header=TRUE, sep=",")
input.ct.persons     <- read.table(file = file.path(TARGET_DIR,"modelfiles",paste0("personData_",ITER,".csv")),
                                   header=TRUE, sep = ",")
```
...
indiv_tours     <- tbl_df(read.table(file=file.path(TARGET_DIR,"modelfiles",
...
joint_tours    <- tbl_df(read.table(file=file.path(TARGET_DIR,"modelfiles",
...
add_cost <- function(this_timeperiod, tours, reverse_od=FALSE) {
  ...
  costSkims   <- read.table(file = file.path(TARGET_DIR,"modelfiles",
...
add_distance <- function(this_timeperiod, tours) {
  ...
  distSkims   <- read.table(file = file.path(TARGET_DIR,"modelfiles",
...
add_time <- function(this_timeperiod, tours, reverse_od=FALSE) {
  ...
  timeSkims   <- read.table(file = file.path(TARGET_DIR,"modelfiles",
...
add_active <- function(this_timeperiod, trips) {
  ...
  activeSkims <- read.table(file = file.path(TARGET_DIR,"modelfiles",
...
indiv_trips     <- read.table(file=file.path(TARGET_DIR,"modelfiles",
...
joint_trips     <- tbl_df(read.table(file=file.path(TARGET_DIR,"modelfiles",
...
mandatory_locations <- tbl_df(read.table(file=file.path(TARGET_DIR,"modelfiles",
...
save(model_summary, file=file.path(TARGET_DIR,"summary","ActiveTransport.rdata"))
...
save(model_summary, file=file.path(TARGET_DIR,"summary","ActivityPattern.rdata"))
...
save(model_summary, file=file.path(TARGET_DIR,"summary","AutomobileOwnership.rdata"))
```
...
write.table(commute_summary, file.path(TARGET_DIR,"summary","CommuteByEmploymentLocation.csv"),
            sep=",", row.names=FALSE)
model_summary <- commute_summary  # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR,"summary","CommuteByEmploymentLocation.rdata"))
...
save(model_summary, file=file.path(TARGET_DIR,"summary","CommuteByIncomeJob.rdata"))
...
save(model_summary, file=file.path(TARGET_DIR,"summary","CommuteByIncomeHousehold.rdata"))
...
write.table(journeytowork_summary,
            file.path(TARGET_DIR,"summary","JourneyToWork.csv"), sep=",", row.names=FALSE)
model_summary <- journeytowork_summary  # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR,"summary","JourneyToWork.rdata"))
...
write.table(timeofday_summary,
            file.path(TARGET_DIR,"summary","TimeOfDay.csv"), sep=",", row.names=FALSE)
model_summary <- timeofday_summary # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR, "summary", "TimeOfDay.rdata"))
...
write.table(persons_touring,
            file.path(TARGET_DIR,"summary","TimeOfDay_personsTouring.csv"), 
            sep=",", row.names=FALSE)
model_summary <- persons_touring
save(model_summary, file=file.path(TARGET_DIR, "summary", "TimeOfDay_personsTouring.rdata"))
...
write.table(tripdist_summary,
            file.path(TARGET_DIR,"summary","TripDistance.csv"), sep=",", row.names=FALSE)
model_summary <- tripdist_summary # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR, "summary", "TripDistance.rdata"))
...
write.table(travelcost_summary,
            file.path(TARGET_DIR,"summary","TravelCost.csv"), sep=",", row.names=FALSE)
model_summary <- travelcost_summary # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR, "summary", "TravelCost.rdata"))
...
write.table(triptime_summary,
            file.path(TARGET_DIR,"summary","PerTripTravelTime.csv"), sep=",", row.names=FALSE)
model_summary <- triptime_summary # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR, "summary", "PerTripTravelTime.rdata"))
...
persons          <- left_join(persons, select(households, hh_id, taz, COUNTY, 
...
vmt_summary      <- summarise(group_by(persons, COUNTY, taz, walk_subzone, walk_subzone_label,
...
write.table(vmt_summary,
            file.path(TARGET_DIR,"summary","VehicleMilesTraveled.csv"), sep=",", row.names=FALSE)
model_summary <- vmt_summary # name it generically for rdata
save(model_summary, file=file.path(TARGET_DIR, "summary", "VehicleMilesTraveled.rdata"))
