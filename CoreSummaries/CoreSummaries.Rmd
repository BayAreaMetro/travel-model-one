...
LOOKUP_PTYPE         <- data.frame(ptype=c(1,2,3,4,5,6,7,8),
                                   pytpe_label=c("Full-time worker","Part-time worker","College student","Non-working adult",
...
Add some variable to trips, such as:
  ...
  * `incQ` from the household table
  * `autoSuff` from the household table
...
trips <- left_join(trips,
                   select(households, hh_id, incQ, incQ_label, autoSuff, autoSuff_label),
                   by=c("hh_id"))
```
