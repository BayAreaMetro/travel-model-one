...
commute_tours   <- select(indiv_tours, hh_id, person_id, orig_taz, dest_taz, tour_purpose,
                          start_hour, end_hour, tour_mode, income, incQ, incQ_label)
...
commute_tours   <- mutate(commute_tours, 
                          parking_cost=ifelse((tour_mode==3)|(tour_mode==4),parking_cost/1.75,parking_cost))
commute_tours   <- mutate(commute_tours,
                          parking_cost=ifelse((tour_mode==5)|(tour_mode==6),parking_cost/2.50,parking_cost))
...
commute_inc_summary_byjob <- summarise(group_by(commute_tours, COUNTY, county_name, SD, dest_taz, 
...
tours <- rbind(select(indiv_tours, -person_id, -person_num, -person_type, -atWork_freq),
