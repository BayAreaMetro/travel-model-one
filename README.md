...
4. Version 1.5 -- Maintained in branch [`master`](https://github.com/BayAreaMetro/travel-model-one/tree/master). Latest relase is [TM1.5.2.5](https://github.com/BayAreaMetro/travel-model-one/releases/tag/TM1.5.2.5).
