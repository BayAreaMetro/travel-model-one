...
4. Version 1.5 -- Maintained in branch [`TM1.5`](https://github.com/BayAreaMetro/travel-model-one/tree/TM1.5). Latest relase is [TM1.5.2.6](https://github.com/BayAreaMetro/travel-model-one/releases/tag/TM1.5.2.6).
