...
/**
 * MODIFIED GZIPOutputStream
 *
 * 1. Made write method un-synchronized.
 *
 * This class implements a stream filter for writing compressed data in
 * the GZIP file format.
 */
public class DAFGZIPOutputStream  extends DeflaterOutputStream {
     ...
     */
    public DAFGZIPOutputStream(OutputStream out, int size) throws IOException {
     ...
     * @exception IOException If an I/O error has occurred.
     */
    public DAFGZIPOutputStream(OutputStream out) throws IOException {
	this(out, 512);
    }
