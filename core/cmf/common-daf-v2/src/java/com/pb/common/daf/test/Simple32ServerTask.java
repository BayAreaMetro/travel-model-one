...
/**
 * Simple32ServerTask is a class that ...
 *
 * @author Kimberly Grommes
 * @version 1.0, Jan 3, 2008
 *          Created by IntelliJ IDEA.
 */
public class Simple32ServerTask extends MessageProcessingTask {

    Logger serverLogger = Logger.getLogger(Simple32ServerTask.class);

    String[] queueNames = {"Worker32Queue1"};
    ...
    public void onMessage(Message msg){
        ...
        if (counter == queueNames.length) {
            ...
            File doneFile = new File("/osmp_gui/java_files/daf/32daf_done.txt");
            if(!doneFile.exists()){
                try {
