...
/**
 * Simple32WorkerTask is a class that ...
 *
 * @author Kimberly Grommes
 * @version 1.0, Jan 3, 2008
 *          Created by IntelliJ IDEA.
 */
public class Simple32WorkerTask extends MessageProcessingTask {
    public static Logger logger = Logger.getLogger(Simple32WorkerTask.class);
    ...
    public void onMessage(Message msg) {
        ...
        sendTo("Simple32ServerQueue", message);
