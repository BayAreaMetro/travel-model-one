...
| num_ftworkers_wWrkLoc | Number of full-time workers who their have usual work locations at this Superdistrict. \s Note that the values in this column are almost equal to but not exactly the same as the sum of ftworkers_RETEMPN, ftworkers_FPSEMPN, ftworkers_HEREMPN, ftworkers_OTHEMPN, ftworkers_AGREMPN and ftworkers_MWTEMPN, because the destination choice size coefficients do not always add up to exactly 1. |
