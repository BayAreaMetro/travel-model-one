...
if not exist "%BOX_DIR%\%MODEL_ID%\PopSynHousehold.zip" ("%ZIPPER%" a "%BOX_DIR%\%MODEL_ID%\householdData.zip" "%MODEL_DIR%\INPUT\popsyn\hhFile*.csv")
if not exist "%BOX_DIR%\%MODEL_ID%\PopSynPerson.zip"    ("%ZIPPER%" a "%BOX_DIR%\%MODEL_ID%\personData.zip"    "%MODEL_DIR%\INPUT\popsyn\personFile*.csv")
