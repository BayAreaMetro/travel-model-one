USAGE = """
    ...
    This script is run after the Travel Model and the two post-processing scripts (BetweenZonesVMT.py and CreateSpeedBinsWithinZones.job).
    ...
    The custom activty template serves as an input to EMFAC. The template generated by this script works for EMFAC versions 2014 and 2017.
    
    This script requires a single argument to determine whether the template was generated for an "SB375" or an "AQ Conformity" analysis. See example;
    call below:
    
    python CTRAMP\scripts\emfac\emfac_prep.py "AQ Conformity"
...
parser.add_argument('analysis_type', metavar='A', type=str, help='Type of analysis for EMFAC run (SB375 or AQ Conformity)')
...
if "Winter" in emfac_input_xlsx:
    output_excel_template = "emfac_prep\\ready4emfac_" + run_id + "_WINTER.xlsx"
elif "Summer" in emfac_input_xlsx:
    output_excel_template = "emfac_prep\\ready4emfac_" + run_id + "_SUMMER.xlsx"
else:
...
if args.analysis_type == "SB375":
    sheet["C1"] = "Sub-Area2"
    print "Rename Column C 'Sub-Area2'"
...
if args.analysis_type == "AQ Conformity":
    TM_HourlyFraction_df = TM_HourlyFraction_df[['Air Basin', 'GAI', 'Sub-Area', 'Cal_Year', 'Veh_Tech', 'Hour',
...
# make "Daily_VMT_By_Veh_Tech tab" the active tab
...
print DefaultVMT_df.columns.values
...
if args.analysis_type == "AQ Conformity":
    TM_VMT_By_Veh_Tech_df =  DefaultVMT_df[['Air Basin', 'GAI', 'Sub-Area', 'Cal_Year_x', 'Veh_Tech', 'modelled_VMT']]
