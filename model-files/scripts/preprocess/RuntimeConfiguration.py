...
def config_distribution(replacements):
    ...
    elif hostname in ['MODEL2-A','MODEL2-B','MODEL2-C','MODEL2-D','PORMDLPPW01','PORMDLPPW02','Model3-a','Model3-b','model3-c','model3-d'] or hostname.startswith("WIN-") or hostname.startswith("azmdl"):
