...
def config_distribution(replacements):
    ...
    elif hostname in ['MODEL2-A','MODEL2-B','MODEL2-C','MODEL2-D','PORMDLPPW01','PORMDLPPW02'] or hostname.startswith("WIN-") or hostname.lower().startswith("azmdl") or hostname.lower().endswith('grtm'):
