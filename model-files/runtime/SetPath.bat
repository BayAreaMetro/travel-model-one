...
:: The commpath
SET COMMPATH=D:\Projects\BCM\COMMPATH
...
set R_HOME=C:\Program Files\R\R-4.1.2\bin\x64
set R_LIB=C:\Users\USJH706661\Documents\R\win-library\4.1
if "%COMPUTER_PREFIX%" == "WIN-" (
  set R_LIB=C:\Users\USJH706661\Documents\R\win-library\4.1
)
...
set PYTHON_PATH=D:\Projects\py27
