...
3. Different than the effort for 2015, many small area variables (such as age, total employment, etc.) are
   available from Census 2020 data. 

3. TAZs are scaled up to match Census 2020 totals (possibly small area, but may be at the county level). 
